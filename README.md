...
![C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\水果收藏.jpg](/md/blog.007.jpeg "C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\水果收藏.jpg")
图4.1 水果收藏实体属性图

（2）下图是用户实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\用户.jpg](/md/blog.008.jpeg "C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\用户.jpg")
图4.2 用户实体属性图

（3）下图是水果实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\水果.jpg](/md/blog.009.jpeg "C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\水果.jpg")
图4.3 水果实体属性图

（4）下图是购物车实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\购物车.jpg](/md/blog.010.jpeg "C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\购物车.jpg")
图4.4 购物车实体属性图

（5）下图是公告实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\公告.jpg](/md/blog.011.jpeg "C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\公告.jpg")
图4.5 公告实体属性图

（6）下图是单页数据实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\单页数据.jpg](/md/blog.012.jpeg "C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\单页数据.jpg")
图4.6 单页数据实体属性图

（7）下图是商家实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\商家.jpg](/md/blog.013.jpeg "C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\商家.jpg")
图4.7 商家实体属性图

（8）下图是水果评价实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\水果评价.jpg](/md/blog.014.jpeg "C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\水果评价.jpg")
图4.8 水果评价实体属性图

（9）下图是水果订单实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\水果订单.jpg](/md/blog.015.jpeg "C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\水果订单.jpg")
图4.9 水果订单实体属性图

（10）下图是收货地址实体和其具备的属性。

![C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\收货地址.jpg](/md/blog.016.jpeg "C:\Users\Administrator\Desktop\img\shuiguozaixianxiaoshou\收货地址.jpg")
图4.10 收货地址实体属性图

### 4.4.2 数据库表结构
在进行这部分设计之前，需要明白和掌握数据类型以及各个数据类型的长度范围等知识，因为在一张具体的数据表中，为了方便理解，这里就举个简单的例子。比如用户信息表，这个表格的字段就是用户这个实体具备的属性，这时就需要对字段进行数据类型，以及字段长度的设置，也要设置一个主键来作为用户信息表的唯一标识。这些都是数据库表结构设计需要完成的内容。根据精品水果线上销售网站的功能设计以及数据库设计要求，展示该系统的数据表结构。
...
|6|shuiguo\_types|Integer|一级分类|是|
|7|shuiguo\_erji\_types|Integer|二级分类|是|
|8|tuijian\_types|Integer|是否推荐|是|
|9|tejia\_types|Integer|是否特价|是|
|10|jinkou\_types|Integer|是否进口|是|
|11|shuiguo\_kucun\_number|Integer|水果库存|是|
|12|shuiguo\_old\_money|BigDecimal|水果原价|是|
|13|shuiguo\_new\_money|BigDecimal|现价|是|
|14|shuiguo\_clicknum|Integer|点击次数|是|
|15|shuiguo\_content|String|水果介绍|是|
|16|shangxia\_types|Integer|是否上架|是|
|17|shuiguo\_delete|Integer|逻辑删除|是|
...
|8|shuiguo\_order\_courier\_name|String|快递公司|是|
|9|shuiguo\_order\_courier\_number|String|订单快递单号|是|
|10|shuiguo\_order\_types|Integer|订单类型|是|
|11|shuiguo\_order\_payment\_types|Integer|支付类型|是|
...
|9|shangjia\_yesno\_types|Integer|审核状态|是|
|10|shangjia\_yesno\_text|String|审核意见|是|
|11|shangjia\_shenhe\_time|Date|审核时间|是|
|12|shangjia\_delete|Integer|逻辑删除|是|
|13|create\_time|Date|创建时间|是|
表4.12管理员表
